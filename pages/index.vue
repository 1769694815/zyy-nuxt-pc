...
export default {
  ...
  async asyncData({ $axios }) {
    let [
      ...
      $axios('/yxs/api/web/course/getIndexCategoryByCode', { params: { code: 'zydjt' }}),
      $axios('/yxs/api/web/course/getIndexCategoryByCode', { params: { code: 'xlzk' }}),
      $axios('/yxs/api/web/course/getIndexCategoryByCode', { params: { code: 'career' }}),
      $axios('/yxs/api/web/course/getIndexCategoryByCode', { params: { code: 'zyzg' }}),
